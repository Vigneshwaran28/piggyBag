...
val YuseiMagicFontFamily = FontFamily(
    Font(R.font.yusei_magic, FontWeight.Normal)
)

val SmoochSansFontFamily = FontFamily(
    Font(R.font.smooch_sans, FontWeight.Normal)
)

val ShadowsIntoLightFontFamily = FontFamily(
    Font(R.font.shadows_into_light, FontWeight.Normal)
)

val CormorantFontFamily = FontFamily(
    Font(R.font.cormorant, FontWeight.Normal)
)

val AmaticSCFontFamily = FontFamily(
    Font(R.font.amatic_sc, FontWeight.Normal)
)
...
val Typography = getTypographyForFont(IBMPlexSansFontFamily)
