...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxComposeUiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        private final AndroidxComposeUiTextLibraryAccessors laccForAndroidxComposeUiTextLibraryAccessors = new AndroidxComposeUiTextLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>androidx.compose.ui.text</b>
         */
        public AndroidxComposeUiTextLibraryAccessors getText() {
            return laccForAndroidxComposeUiTextLibraryAccessors;
        }
    ...
    public static class AndroidxComposeUiTextLibraryAccessors extends SubDependencyFactory {
        private final AndroidxComposeUiTextGoogleLibraryAccessors laccForAndroidxComposeUiTextGoogleLibraryAccessors = new AndroidxComposeUiTextGoogleLibraryAccessors(owner);

        public AndroidxComposeUiTextLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.compose.ui.text.google</b>
         */
        public AndroidxComposeUiTextGoogleLibraryAccessors getGoogle() {
            return laccForAndroidxComposeUiTextGoogleLibraryAccessors;
        }

    }

    public static class AndroidxComposeUiTextGoogleLibraryAccessors extends SubDependencyFactory {

        public AndroidxComposeUiTextGoogleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getFonts() {
            return create("androidx.compose.ui.text.google.fonts");
        }
